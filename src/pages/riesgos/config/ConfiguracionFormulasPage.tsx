...
import { useConfiguracionFormulasPage } from '@/pages/riesgos/hooks/useConfiguracionFormulasPage';

export const ConfiguracionFormulasPage: React.FC = () => {
  const { navigate, config, setConfig, configQuery, saveMutation, sumaPonderaciones, esValido, handleGuardar } =
    useConfiguracionFormulasPage();
