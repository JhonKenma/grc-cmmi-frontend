...
import { Power, PowerOff, ArrowLeft, FileText, Layers, CheckCircle, Calendar, Edit, Download } from 'lucide-react';
import { Button, LoadingScreen, Card } from '@/components/common';
import { DimensionCard } from './components/DimensionCard';
import { usePermissions } from '@/hooks/usePermissions';
import { formatDate } from '@/utils/helpers';
import { useDetalleEncuesta } from './hooks';
...
export const DetalleEncuesta: React.FC = () => {
  ...
  if (isLoading) return <LoadingScreen message="Cargando encuesta..." />;
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-bold text-gray-900">{encuesta.nombre}</h1>
        ...
        {isSuperuser && (
          <div className="flex items-center gap-3">
            ...
            <Button variant="primary" size="md" onClick={goToEditar}>
        ...
        <Card padding="md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{encuesta.total_dimensiones}</p>
            </div>
        ...
        <Card padding="md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-1">{encuesta.total_preguntas}</p>
            </div>
        ...
        <Card padding="md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base font-semibold text-gray-900 mt-1">{formatDate(encuesta.fecha_creacion)}</p>
            </div>
        ...
        <Card padding="md">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-base font-semibold text-gray-900 mt-1">{formatDate(encuesta.fecha_actualizacion)}</p>
            </div>
        ...
        {encuesta.dimensiones.length === 0 ? (
          ...
          <div className="space-y-4">
            {encuesta.dimensiones
              ...
              .map((dimension, index) => (
                <DimensionCard key={dimension.id} dimension={dimension} numero={index + 1} />
              ))}
          </div>
        )}
      </div>
