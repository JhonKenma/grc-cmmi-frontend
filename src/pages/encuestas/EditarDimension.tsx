...
import { useEditarDimension } from './hooks';

export const EditarDimension: React.FC = () => {
  const { isLoading, form, onSubmit, goToDetalle } = useEditarDimension();
  const { register, formState: { errors, isSubmitting } } = form;

  if (isLoading) return <LoadingScreen message="Cargando dimensión..." />;
